...
```css
body {
  font-size: var(--brand-font-size-100);
...
html[data-brand="insert-your-brand"] {
  --brand-font-family: system-ui;
  /* GREY */
  --brand-grey-800: oklch(38.666% 0.00004 271.152);
  /* RED */
  --brand-red-400: oklch(69.42% 0.16807 22.436);
  /* BLUE */
  --brand-blue-500: oklch(75.415% 0.12865 244.876);
}
```
...
:where(html) {
  ...
  --text-color: var(--brand-grey-900);
  --text-color-error: var(--brand-red-400);
  --surface-elevated: var(--brand-grey-100);
}

html[data-theme="dark"] {
  --color-bg: var(--brand-grey-900);
  --text-color: var(--brand-grey-100);
  --text-color-error: var(--brand-red-200);
}
```
